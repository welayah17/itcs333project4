...
<head>
  ...
  <title>SM: Item Details View</title>
...
<body>
  ...
  <!-- Responsive Product Detail Section -->
<!-- Responsive Product Detail Section -->
...
<div id="deleteMessage" class="text-center mt-5" style="display: none;"></div>

<section id="itemDetails" class="product">
  <div>
    <img id="itemImage" class="img-thumbnail" alt="Item image">
  </div>
  <div class="details">
    <div class="title">
    ...
    <div class="description">
      <p class="price item-price">Price: BD <span id="itemPrice">49.99</span></p>
      <p id="itemDescription" class="item-description">Detailed description of the item...</p>
      <p id="itemCategory" class="item-category">Category: Example Category</p>
      <p id="itemStatus" class="item-status">Status: Available</p>
      <p id="itemPhone" class="phoneNumber">Phone Number: 53563366</p>
    </div>
    <div class="rating">
      <a href="Review.html">
      <p>87 ratings - 4.5 out of 5</p>
      <i class="fa-solid fa-star"></i>
      <i class="fa-solid fa-star"></i>
      <i class="fa-solid fa-star"></i>
      <i class="fa-solid fa-star"></i>
      <i class="fa-solid fa-star-half-stroke"></i>
      <button class="btn btn-outline-info btn-sm mt-2">Add Review</button>
      </a>
    </div>

    <div class="mt-3">
      <a id="editLink" href="../Student Marketplace/EditItem.php">
    ...
    <div class="mt-4">
      ...
      <button class="btn-style btn btn-primary">Submit Comment</button>
    </div>

    <a href="#" onclick="history.back()" class="btn-style btn btn-secondary mt-4">
      <i class="fa-solid fa-list"></i> Back to Listing
    </a>    
  </div>
</section>
  ...
  <script src="../Student Marketplace/detail.js"></script>
</body>
</html>
